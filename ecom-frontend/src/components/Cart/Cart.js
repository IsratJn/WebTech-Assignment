...
const Cart = props => {
    ...
    return (
        <div className="container-sm">
                        ...
                        return <li className="list-group-item border border-dark my-1">
                            <div className="d-flex flex-row-reverse">
                                ...
                                <div className="d-flex flex-row">
                                    ...
                                    <p className="h5 ml-5 text-secondary">{product.price} Tk.</p>
                                </div>
            ...
            {products.length > 0
                ? <button className="btn btn-outline-primary" onClick={() => {placeOrderHandler();toast.info('Order Placed Successfully',{autoClose:1500})}}>
